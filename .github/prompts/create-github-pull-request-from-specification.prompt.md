...
- [ ] No new top-level packages introduced
- [ ] Pipeline architecture preserved
- [ ] CLI remains thin

## Detection governance
- [ ] New rules include corpus evidence
- [ ] Golden corpus updated if detection behavior changed
- [ ] Parser fidelity impact reviewed